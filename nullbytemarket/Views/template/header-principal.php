   ...
   <div class="banner_bg_main">
      ...
      <div class="logo_section">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <div class="logo"><a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>assets/images/nullbytelogo.png" width="50"></a></div>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="containt_main">
               ...
               <div class="main">
                  ...
                  <div class="input-group">
                     <input type="text" class="form-control" placeholder="Busca tus productos favoritos" id="search">
