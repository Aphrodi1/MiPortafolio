...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo BASE_URL; ?>assets/images/nullbytelogo.png">
  <link rel="icon" type="image/png" href="<?php echo BASE_URL; ?>assets/images/nullbytelogo.png">
  <title>
    NullByteMarket ADMIN
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?php echo BASE_URL; ?>" target="_blank">
        <img src="<?php echo BASE_URL; ?>assets/images/nullbytelogo.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold text-white">NullByteMarket</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'administracion') ? 'active bg-gradient-primary' : ''; ?>" href="<?php echo BASE_URL . 'admin/home'; ?>">
            ...
            <span class="nav-link-text ms-1">Graficos de Venta</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'pedidos') ? 'active bg-gradient-primary' : ''; ?>" href="<?php echo BASE_URL . 'pedidos'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">fact_check
              </i>
            </div>
            <span class="nav-link-text ms-1">Pedidos y Procesos</span>
          </a>
        </li>
      </ul>
    </div>
